...
#------------------------------------------
	...
	piedra_mas = get_node("piedra_mas")
	piedra_mas.set_contact_monitor(true)
	piedra_mas.set_max_contacts_reported(true)

	piedra_circulo = get_node("piedra_circulo")
	piedra_circulo.set_contact_monitor(true)
	piedra_circulo.set_max_contacts_reported(true)
...
#------BALANZAS---------------------------
	...
	var balanza_4 = get_node("balanza_auto4")
	var balanza_5 = get_node("balanza_auto5")
	var balanza_7 = get_node("balanza_auto7")

	if balanza_4 in piedra_mas.get_colliding_bodies() and  balanza_5 in piedra_menos.get_colliding_bodies() and  balanza_7 in piedra_circulo.get_colliding_bodies():
		if balanza == 1:
			balanza = 0
			get_node("caminos/puente").puente()
...
#--------------transicion escenas--------------
func misio_fuego():
	get_tree().change_scene("res://niveles/level_02_c.scn")
