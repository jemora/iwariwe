...
export(Texture) var texture = preload("res://Sprites/terreno_03.png") setget setBakeInterval
export(Texture) var textureL = preload("res://Sprites/terreno_03_l.png")
export(Texture) var textureR = preload("res://Sprites/terreno_03_r.png")
...
var font = preload("res://../fonts/font.fnt")
